...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8 = st.tabs([
    "Sales Overview", "Ticket Types", "Service Analysis",
...
with tab1:
    ...
    summary_tab1 = filtered_df.agg({
        "px_total_amount": ["sum", "mean", "max", "min"],
        "travelled_KM": ["mean", "max"],
        "revenue_per_km": ["mean"]
    }).rename(index={
        "sum": "Total Revenue",
        "mean": "Average",
    ...
    st.dataframe(summary_tab1, use_container_width=True)
